...
export const APPEARANCE_TOKEN_NAMES = [
  ...
  "semantic-thread-user-turn-diff-card-surface-light",
  "semantic-thread-user-turn-diff-card-surface-dark",
  "semantic-thread-user-turn-diff-card-border-light",
  "semantic-thread-user-turn-diff-card-border-dark",
  "semantic-thread-user-turn-diff-divider-light",
  "semantic-thread-user-turn-diff-divider-dark",
  "semantic-thread-user-turn-diff-row-surface-hover-light",
  "semantic-thread-user-turn-diff-row-surface-hover-dark",
  "semantic-thread-user-turn-diff-row-surface-focus-light",
  "semantic-thread-user-turn-diff-row-surface-focus-dark",
  "semantic-thread-user-turn-diff-preview-surface-light",
  "semantic-thread-user-turn-diff-preview-surface-dark",
...
const DEFAULT_APPEARANCE_RESOLVED_TOKENS = {
  ...
  "semantic-settings-page-surface-light": "#ffffff",
  "semantic-settings-page-surface-dark": "#221d1a",
