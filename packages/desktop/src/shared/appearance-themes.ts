...
const TRANSPARENT_FROSTED_OVERRIDES = {
  ...
  "semantic-markdown-table-row-alt-surface-dark": "#363636",
  "semantic-segmented-control-item-surface-active-dark": "rgba(221, 221, 221, 0.38)",
  "semantic-thread-user-message-diff-card-border-light": "rgba(231, 229, 228, 0)",
  "semantic-thread-user-message-diff-card-surface-light": "rgba(255, 255, 255, 0.1)",
  "semantic-thread-user-message-diff-divider-light": "rgba(255, 255, 255, 0.21)",
  "semantic-thread-user-message-diff-row-surface-hover-light": "rgba(222, 222, 222, 0.14)",
