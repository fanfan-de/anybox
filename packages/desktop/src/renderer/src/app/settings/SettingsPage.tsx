...
interface SettingsPageProps {
  ...
  isSemanticTokenInspectorEnabled: boolean
  ...
  onSemanticTokenInspectorChange: (value: boolean) => void
...
export function SettingsPage({
  ...
  onSemanticTokenInspectorChange,
                ...
                <div className="settings-developer-layout">
                  ...
                  >
                    <div className="settings-section-summary">
                      ...
                      <button
                        className={isSemanticTokenInspectorEnabled ? "settings-toggle-card is-active" : "settings-toggle-card"}
                        role="switch"
                        aria-checked={isSemanticTokenInspectorEnabled}
                        aria-label="Enable Semantic Token Inspector"
                        type="button"
                        onClick={() => onSemanticTokenInspectorChange(!isSemanticTokenInspectorEnabled)}
                      >
                        <span className="settings-toggle-copy">
                          <strong className="settings-toggle-title">
                            <span className="settings-toggle-icon" aria-hidden="true">
                            ...
                            <span>Semantic Token Inspector</span>
                          </strong>
                          <small>Hover UI to reveal the active color declaration, token chain, computed value, and source.</small>
                        </span>
                        <span className="settings-toggle-control" aria-hidden="true">
                          <span className="settings-toggle-thumb" />
                        </span>
                  ...
                  >
                    <div className="settings-section-summary">
                      ...
                      <article className="settings-summary-card">
                        <span className="label">Token Inspector</span>
                        <strong>{isSemanticTokenInspectorEnabled ? "Active" : "Inactive"}</strong>
                        <p>
                          {isSemanticTokenInspectorEnabled
                            ? "Hovering the interface reveals active color declarations and semantic token chains; press Esc to exit."
                            : "Semantic token inspection is disabled and no Chromium debugger session is attached."}
                        </p>
                      </article>
                      <article className="settings-summary-card">
