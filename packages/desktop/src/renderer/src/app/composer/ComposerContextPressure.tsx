...
interface ComposerContextPressureProps {
  ...
  return (
    <div className="context-pressure-anchor">
      <button
        ...
        className={
          isContextPanelOpen
            ? `composer-selector-button is-icon-only context-pressure-indicator is-${pressureState} is-active`
            : `composer-selector-button is-icon-only context-pressure-indicator is-${pressureState}`
        }
      ...
      >
        <svg aria-hidden="true" className="context-pressure-ring" viewBox={`0 0 ${String(size)} ${String(size)}`}>
          <circle
            className="context-pressure-ring-track"
            cx={String(center)}
            cy={String(center)}
            r={String(radius)}
          />
