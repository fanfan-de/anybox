...
describe("ThreadView trace item renderers", () => {
  ...
  it("renders a matching pending permission request alongside the approval event row", () => {
    ...
    expect(within(approvalRow!).getByText("Needs your confirmation")).toBeInTheDocument()
    expect(within(approvalRow!).getByText("Permission requested")).toBeInTheDocument()
