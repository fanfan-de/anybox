...
describe("RightSidebar", () => {
  ...
  it("folds answered AskUserQuestion cards with processing in Branch Chat", async () => {
    ...
    const tab = {
      ...createBranchChatTab(),
      headMessageID: "assistant-response",
      phase: "committed" as const,
    }
    window.desktop = {
      ...previousDesktop,
        ...
        loadHistory: vi.fn().mockResolvedValue([
          ...
          },
          {
            ...
            turn: {
              ...
              lastMessageID: "assistant-response",
              status: "completed",
              phase: "completed",
              createdAt: 3,
              updatedAt: 5,
            ...
            parts: [
              {
                ...
                type: "reasoning",
                time: { start: 3 },
                text: "Preparing the selected branch deployment target and validating its completed configuration. ".repeat(3),
              },
              {
                id: "tool-question",
                sessionID: "session-1",
                ...
                retry: { attempt: 1 },
                revision: 1,
                timestamps: { createdAt: 4, startedAt: 4, settledAt: 5 },
                state: {
                  phase: "settled",
                  outcome: {
                    kind: "returned",
          ...
          },
          {
            info: {
              ...
              created: 5,
              completed: 5,
              parentMessageID: "assistant-question",
              finishReason: "stop",
            },
            turn: {
              id: "turn-question",
            ...
            parts: [
              {
                ...
                type: "text",
                time: { start: 5 },
                text: "The Vercel branch target is configured.",
              },
            ],
          },
        ]),
