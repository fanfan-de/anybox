...
const MANAGED_AGENT_COMPUTER_USE_REQUIRE_SIGNATURE_ENV =
...
function buildManagedAgentStartEnv(
  ...
  if (app.isPackaged && process.platform === "win32") {
    startEnv[MANAGED_AGENT_COMPUTER_USE_REQUIRE_SIGNATURE_ENV] = "1"
  }
...
export const managedAgentInternals = {
  ...
  env: {
    ...
    computerUseRequireSignature:
      MANAGED_AGENT_COMPUTER_USE_REQUIRE_SIGNATURE_ENV,
