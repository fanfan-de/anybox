...
const tools = [
  ...
  },
  {
    ...
    title: "Chrome Interactive Snapshot",
...
async function agentFetch(path, options) {
  if (typeof fetch !== "function") {
    throw new Error("The Chrome MCP runtime requires a Node.js runtime with fetch support.")
  }
    ...
    if (message.method === "initialize") {
      send({
        ...
        result: {
          ...
          serverInfo: { name: "anybox-chrome", version: "0.1.0" },
        },
      })
      return
    }
