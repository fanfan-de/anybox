...
import { isSshWorkspaceUri } from "#platform/workspace-uri.ts"
import type { CinemaAssetRecordMutationResult } from "@anybox/cinema-plugin/contracts"
...
function resolveLibraryPaths(scope: CinemaAssetScope): CinemaAssetLibraryPaths {
  ...
  return {
    scope,
    scopeKey: `cinema-library:project:${cinemaRoot}`,
