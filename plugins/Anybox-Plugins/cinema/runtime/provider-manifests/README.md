...
```text
packages/anyboxagent/src/cinema/provider-manifests/klingai-cn/models/kling-v3.json
```

适用文件位置：

```text
packages/anyboxagent/src/cinema/provider-manifests/<provider-id>/models/<model-id>.json
```
